package com.wipro.order.domain;
 ...
 */
@Entity
@Table(name = "ace_persistent_audit_event")
public class PersistentAuditEvent implements Serializable {
    ...
    @Column(name = "value")
    @CollectionTable(name = "ace_persistent_audit_evt_data", joinColumns=@JoinColumn(name="event_id"))
