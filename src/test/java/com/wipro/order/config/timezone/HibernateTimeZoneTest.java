package com.wipro.order.config.timezone;

import com.wipro.order.OrderApp;
import com.wipro.order.repository.timezone.DateTimeWrapper;
import com.wipro.order.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneTest {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM ace_date_time_wrapper where id=%d", fieldName, id);
    }
